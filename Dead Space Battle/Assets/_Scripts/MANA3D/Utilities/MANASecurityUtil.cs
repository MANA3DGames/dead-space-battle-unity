...
namespace MANA3D.Utilities.Security
{
    public static class PlayerPrefsExtensions
	{
		...
		public static void save( this PlayerPrefs obj, string key, int val )
		{
			savePlayerPref( key, System.Convert.ToString( val ) );
		}
		
		public static void save( this PlayerPrefs obj, string key, float val)
		{
			savePlayerPref( key, System.Convert.ToString( val ) );
		}
		
		public static void save( this PlayerPrefs obj, string key, string val)
		{
			savePlayerPref( key, val );
		}
		
		public static string loadString( this PlayerPrefs obj, string key )
		{
		...
		public static float loadFloat( this PlayerPrefs obj, string key )
		{
		...
		public static int loadInt( this PlayerPrefs obj, string key )
		{
			if ( !checkHasKey( key ) ) return 0;
